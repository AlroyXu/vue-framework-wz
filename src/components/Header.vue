  ...
  <navbar>
    ...
    <ul class="nav navbar-nav d-md-down-none">
      ...
      <li class="nav-item header-item">
            ...
            <router-link tag="div" to='/home2' style="height:55px;" class="nav-link">
              <p>
                <Icon type="trophy" size='30' color="#2d8cf0"></Icon>
              </p>
              <p style="color:#2d8cf0"> 用户管理 </p>
            </router-link>

...
export const asyncRouterMap = [

  {
    ...
    children: [
      ...
      { path: '/table', name: 'ProjectList', icon: 'ios-paper', component: _import('Table'), meta: { role: ['admin'] } },
      { path: '/project', name: 'Project', icon: 'ios-paper', component: _import('ProList'), meta: { role: ['admin'] } },
...

  {
    ...
    children: [
      ...
      { path: '/home1/introduction', name: '财政收入分析', icon: 'thumbsup', component: _import('Introduction') },
  ...
  },
  {
    ...
    children: [
      // { path: '/home1/dashboard', name: 'Dashboard2', icon: 'speedometer', component: _import('Dashboard2') },
      { path: '/home2/user', name: '权限管理', icon: 'thumbsup', component: _import('user') },
